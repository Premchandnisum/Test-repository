Feature:  New Checkout Regression Testing with different flavours of products.
...
|1310|QA|Macys|685 market street|Montgomery|San Fransisco|California|94538|123|456|3456|Shipping Address is invalid|
...
Then I should see the order summary details are updated after applying promo code
...
Then I should see the order summary details are updated after removing promo code
